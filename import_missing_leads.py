...
# Updated Google Sheets data with all leads including new ones
updated_google_sheets_data = [
    ...
    {'date': '12/12/2025 11:52:47', 'name': 'Ritesh Kothiyal', 'phone': '9910266552', 'email': 'test@gmail.com'},
    {'date': '12/12/2025 13:05:52', 'name': 'Vikas', 'phone': '9650100596', 'email': 'kevinn.shankar@gmail.com'},
    {'date': '12/12/2025 14:54:02', 'name': 'DEEPAK AGARWAL', 'phone': '9411110963', 'email': 'd1001agarwal@gmail.com'},
    {'date': '12/12/2025 19:58:02', 'name': 'M.K.Sharma', 'phone': '9312177979', 'email': 'munnaksharma@gmail.com'},
    {'date': '12/12/2025 20:01:43', 'name': 'M.K.Sharma', 'phone': '9312177979', 'email': 'munnaksharma@gmail.com'},
    {'date': '12/12/2025 20:04:14', 'name': 'M.K.Sharma', 'phone': '9312177979', 'email': 'munnaksharma@gmail.com'},
    {'date': '13/12/2025 10:00:51', 'name': 'Ramesh', 'phone': '9810145592', 'email': ''},
    {'date': '13/12/2025 11:31:13', 'name': 'Ashish jain', 'phone': '9910619338', 'email': 'ashish.jain11300@gmail.com'},
]
...
def import_missing_leads():
    """Import missing leads with correct dates"""
    print("Starting to import missing Google Sheets leads...")
    
    created_count = 0
    existing_count = 0
    error_count = 0
    
    for data in updated_google_sheets_data:
        name = data['name']
        phone = data['phone']
        email = data['email']
        date_str = data['date']
        ...
        try:
            ...
            # Create new lead with correct date
            lead = Lead.objects.create(
                ...
                created_time=correct_date,
                extra_fields={
                    'original_timestamp': date_str,
                    'project_name': 'AU Aspire Leisure Valley',
                    'imported_from': 'missing_leads_script'
                }
            )
            created_count += 1
            print(f"Created: {name} ({phone}) - Date: {correct_date.strftime('%d/%m/%Y %H:%M:%S')}")
            
        except Exception as e:
            error_count += 1
            print(f"Error creating {name} ({phone}): {str(e)}")
    
    print(f"\nSummary:")
    print(f"Created: {created_count} new leads")
    print(f"Already exists: {existing_count} leads")
    print(f"Errors: {error_count} leads")
    print(f"Total processed: {len([d for d in updated_google_sheets_data if d['phone']])}")

if __name__ == "__main__":
    import_missing_leads()