...
class Command(BaseCommand):
    help = 'Import all 321 team members with user accounts'
    ...
    def handle(self, *args, **options):
        ...
        # Complete team data - first 50 members
        team_data_batch1 = [
        ...
        self._import_batch(team_data_batch1, 1)
        self.stdout.write('Batch 1 completed (50 members)')
